...
public class CannonRotateCs : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Factor corrector
        cannonSpeedCorrection = 0.2f;
    }


    void Update()
    {
        // Agregamos un reductor de la velocidad de giro
        // Que desactivamos en cada frame
        float actualSpeedCorrection = 1;

        // Si el jugador pulsa Ctrl derecho se usa el corrector
